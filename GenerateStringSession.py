...
class InteractiveTelegramClient(TelegramClient):
    def __init__(self, session_user_id, api_id, api_hash,
        ...
        self.found_media = {}
        print('@MicroserUserBot String Alıcıya Hoş Geldiniz')
...
if __name__ == '__main__':
   ...
   if secim == 2:
      ...
      if API_ID == "":
         ...
         API_ID = 4
         API_HASH = "105437b05aa56f1dfc876152beb8b31a"
      else:
      ...
      if soup.title.string == "Create new application":
         ...
         AppInfo = {
            "hash": hashh,
            "app_title":"Microser UserBot",
            "app_shortname": "microser" + str(random.randint(9, 99)) + str(time.time()).replace(".", ""),
            "app_url": "",
